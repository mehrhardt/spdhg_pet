"""Compute ML results with subset selection over bins for
...
for dataset in datasets:
    ...
    nsub = {'MLEM': 1, 'OSEM-21': 21, 'COSEM-21': 21, 'SPDHG2-21': 21}
    ...
    for alg in algs:
        ...
        if os.path.exists(file_result):
            ...
            if nsub[alg] > 1:
                partition = mMR.partition_by_bin(nsub[alg])
